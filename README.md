...
Framework-agnostic PHP core for [Crontinel](https://crontinel.com), with data objects, monitor contracts, and alert management.
...
- **Alert management** (`AlertService`), for deduplication, resolution tracking, and dispatch
